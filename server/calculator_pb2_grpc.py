...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Divide = channel.unary_unary(
                ...
                response_deserializer=calculator__pb2.Result.FromString,
                _registered_method=True)
        self.StreamCalculations = channel.unary_stream(
                '/calculator.Calculator/StreamCalculations',
                request_serializer=calculator__pb2.StreamRequest.SerializeToString,
                response_deserializer=calculator__pb2.Result.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamCalculations': grpc.unary_stream_rpc_method_handler(
                    servicer.StreamCalculations,
                    request_deserializer=calculator__pb2.StreamRequest.FromString,
                    response_serializer=calculator__pb2.Result.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    @staticmethod
    def StreamCalculations(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/calculator.Calculator/StreamCalculations',
            calculator__pb2.StreamRequest.SerializeToString,
            calculator__pb2.Result.FromString,
            options,
            channel_credentials,
            insecure,
